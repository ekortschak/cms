...
<form id="inlineEdit" method="post" action="?file_act=save">
	...
	<div id="curEdit" class="inedit"> _
		<textarea id="txtEdit" name="content" class="tarea"  rows="35" spellcheck="false" onkeydown="doStore();"></textarea>
	</div>
...
<form id="inlineEdit" method="post" action="?">
	<textarea id="txtEdit" name="content" tabindex=0 class="tarea" rows="35" spellcheck="false"><!VAR:content!></textarea>
<!SEC:submit!>
</form>
...
<div align="right">
<form method="post" action="?">
	<input type="hidden" name="pic_act" value="x">
	<input type="text" name="uid_tit" value="<!VAR:file!>" class="filename" />
