...
# *****************************************************************
[formatting]
<div class="dropdown"><button class="icon rose" onclick="addTag('p');">¶&ensp;▾</button>
...
[characters]
# *****************************************************************
<div class="dropdown"><button class="icon" onclick="addTag('b');"><b>B</b>&ensp;▾</button>
