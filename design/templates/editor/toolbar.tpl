...
# *****************************************************************
[formatting]
<div class="dropdown"><button class="icon rose" onclick="addTag('p');">¶ &nbsp;▾</button>
...
# listings & tables
# *****************************************************************
<div class="dropdown"><button class="icon rose"><img src="core/icons/buttons/listing.png" /> &nbsp;▾</button>
...
<div class="dropdown"><button class="icon rose"><img src="core/icons/buttons/table.png" /> &nbsp;▾</button>
...
[addImg]
<div class="dropdown">
	<button class="icon rose"><img src="core/icons/buttons/img.png" /> &nbsp;▾</button>
...
[characters]
# *****************************************************************
<div class="dropdown"><button class="icon" onclick="addTag('b');"><b>B</b> ▾</button>
...
[addLFs]
<div class="dropdown"><button class="icon" onclick="insAny('<br>');">&crarr; &nbsp;▾</button>
